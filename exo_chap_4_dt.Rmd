...
countries_dt = countries_dt[,
                            clean_aff := .(unlist(tstrsplit(authors,'<AFFILIATION>',
                                                               keep = 2)))
                            ][,-'authors']
...
tic()
countries_dt[,country := .(str_extract(clean_aff, pattern)),
             by=c('pmid', 'clean_aff')]
toc()
countries_dt

tic()
countries_dt = countries_dt[!is.na(country), -'clean_aff']
