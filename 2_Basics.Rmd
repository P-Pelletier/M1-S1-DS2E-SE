...
Things in Python are more conventional, but since most of you learned R before Python it is important to notice that variables refers to an object but they are still two entities.
...
In Python the most common are List, tuple, sets, Dictionary.
Note that for the moment, for modifying a variable we always use '='. Keep in mind that using the '.' can modify the object behind the variable in Python.
